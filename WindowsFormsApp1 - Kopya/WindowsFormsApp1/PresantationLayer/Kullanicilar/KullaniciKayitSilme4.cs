...
{
    public partial class KullaniciKayitSilme4 : Form
    {
        private TblKullanicilarBLL4 _tblKullanicilarBLL4;
        public KullaniciKayitSilme4()
        {
            InitializeComponent();
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            kullaniciSil = _tblKullanicilarBLL4.silKullanici(txtid2.Text);
        ...
        private void KullaniciKayitSilme4_Load(object sender, EventArgs e)
        {
            Listele();
        }
