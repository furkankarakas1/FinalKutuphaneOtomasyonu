...
{
    public partial class KullaniciListeleme2 : Form
    {
        public SqlCommand sorgu;
        public KullaniciListeleme2()
        {
            InitializeComponent();
        }
        ...
        private void btnListe_Click(object sender, EventArgs e)
        {
            if (rbTümListe.Checked == true)
            {
                ...
                sorgu = new SqlCommand("Select * from tbl_seri ", yeniBaglanti.baglanti);
            ...
            if (RbSeçilen.Checked == true)
            {
                ...
                sorgu = new SqlCommand("Select " + secim_kullaniciAdi + secim_Kadi + 
                    " From tbl_seri", yeniBaglanti.baglanti);
        ...
        private void KullaniciListeleme2_Load(object sender, EventArgs e)
        {
            VeriTabaniBaglantisi yeniBaglanti = new VeriTabaniBaglantisi();
            sorgu = new SqlCommand("Select * from tbl_seri ", yeniBaglanti.baglanti);
