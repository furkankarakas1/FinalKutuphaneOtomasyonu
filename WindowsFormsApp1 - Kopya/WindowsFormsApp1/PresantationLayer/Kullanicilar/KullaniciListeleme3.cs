...
{
    public partial class KullaniciListeleme3 : Form
    {
        public SqlCommand sorgu;
        public KullaniciListeleme3()
        {
            InitializeComponent();
        }
        ...
        private void btnListe_Click(object sender, EventArgs e)
        {
            if (rbTümListe.Checked == true)
            {
                ...
                sorgu = new SqlCommand("Select * from tbl_yas ", yeniBaglanti.baglanti);
            ...
            if (RbSeçilen.Checked == true)
            {
                ...
                sorgu = new SqlCommand("Select " + secim_kullaniciAdi + secim_Kadi +
                    " From tbl_yas", yeniBaglanti.baglanti);
        ...
        private void KullaniciListeleme3_Load(object sender, EventArgs e)
        {
            VeriTabaniBaglantisi yeniBaglanti = new VeriTabaniBaglantisi();
            sorgu = new SqlCommand("Select * from tbl_yas ", yeniBaglanti.baglanti);
